...
class Tweets extends Controller {
  ...
  public function loadcompany_review($company_id) {
    
    $data = [
      'user' => $this->userModel->getUserById(),
      'tweets' => $this->tweetModel->getcompany_review($company_id),
      
    ];

    $this->view('tweets/loadcompany_review', $data);
  }
  ...
  public function company_review() {
    ...
    if(is_ajax_request()) {
      ...
      $post = $this->tweetModel->company_review($review,$company_id,$location);

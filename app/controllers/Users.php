...
class Users extends Controller {
  ...
  public function company($username = '',$company_id) {
   // echo $company_id; exit;
    ...
    $data = [
      ...
      'company_name' => $this->userModel->getcompany_name($company_id),
      //'getcompany_details' => $this->tweetModel->get_company_details($username),
    ];

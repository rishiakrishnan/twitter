    ...
    <div class="nav-wrapper">
      ...
      <ul class="left hide-on-med-and-down">
        <?php if(!Auth::isLoggedIn()): ?>
           <li><a href="<?php echo url_for('users/login') ?>" class="color-black center<?php echo $active === 'tweets' ? ' active': ''; ?>"> Home</a></li>
           <?php else : ?>
           <li><a href="<?php echo url_for('tweets') ?>" class="color-black center<?php echo $active === 'tweets' ? ' active': ''; ?>"> Home</a></li>
          <?php endif; ?>

...
<?php $users = $data['users']; $tweets = $data['tweets']; $getAllUsers = $data['getAllUsers']; $company_name= $data['company_name'];?>
<div class="banner">
    ...
    <div class="row">
        ...
        <div class="card no-shadow">
          <div class="card-content pl-0 pr-0">
            <h1><a href="<?php echo url_for('users/profile/') . $data['username']; ?>">
              <?php echo h(ucwords($company_name->body)); ?></a>
            </h1>
          ...
          <div class="card-action pr-0 hide-on-large-only">
            ...
            <a href="<?php echo url_for('users/following/') . $user->username ?>">Following1<span class="color-twitter center-align"><?php echo $data['total-following']; ?></span></a>
      ...
      <div class="col xl6 l8 m12 s12 pl-0">
        <div class="card card-horizontal tweet no-shadow">
          <form method="post" action="<?php echo url_for('tweets/company_review') ?>" id="postForm">
            <div class="card-content">
              <div class="input-field">
                <textarea id="tweet-body" class="materialize-textarea" data-length="280" placeholder="Write a Review"></textarea>
              </div>
              <div class="input-field">
                <textarea id="location_id" class="materialize-textarea" data-length="280" placeholder="Location"></textarea>
              </div>
            </div>
            <input type="hidden" id="company_id_value" name="company_id" value="<?php echo $data['company_id']; ?>">
            <div class="card-action right-align">
              <input id="postTweetBtn" type="submit" value="Submit" class="btn bg-twitter no-shadow">
            </div>
          </form>
        </div>
...
<input type="hidden" id="company_id" name="company_id" value="<?php echo $data['company_id']; ?>">
